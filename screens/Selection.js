...
const Selection = ({navigation}) => {
    ...
    let onePieceDescription = "GUESS THE MOST POPULAR ONE PIECE CHARACTERS TO BECOME THE PIRATE KING!";
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.form}>
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: animeSet, description: AnimeDescription, category: "ANIME", img: animeImg});
                        }}
                        title="ANIME"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: narutoSet, description: narutoDescription, category: "NARUTO", img: narutoImg});
                        }}
                        title="NARUTO"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: onePieceSet, description: onePieceDescription, category: "ONE PIECE", img: luffyImg});
                        }}
                        title="ONE PIECE"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: myHeroSet, description: myHeroDescription, category: "MY HERO", img: myHeroImg});
                        }}
                        title="MY HERO"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: pokemonSet, description: pokemonDescription, category: "POKEMON", img: pokemonImg});
                        }}
                        title="POKEMON"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: leagueSet, description: lolDescription, category: "LOL", img: leageuImg});
                        }}
                        title="LOL"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: kPopSet, description: kPopDescription, category: "KPOP", img: kpopImg});
                        }}
                        title="KPOP"
                    />
                    <PlayButton
                        ...
                        onPress={() => {
                            first = true;
                            navigation.push("Description", {set: kpopSongSet, description: kPopSongDescription, category: "KPOP DANCES", img: kDanceImg});
                        }}
                        title="KPOP DANCES"
                    />
